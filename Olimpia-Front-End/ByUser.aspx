<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ByUser.aspx.cs" Inherits="Olimpia_Front_End.ByUser" %>
...
<body style="background-color: ghostwhite">
    ...
    <div class="container">
        ...
        <asp:Button runat="server" type="button" Text="Voltar à Máquinas" CssClass="btn-pages-s" ID="Button2" OnClick="btnVoltar_Click"></asp:Button>

        <br />
        <br />
        <label>Escolha o Usuário:</label>
        <asp:DropDownList ID="ddlFiltroUser" runat="server">
            <asp:ListItem Text="" />
        </asp:DropDownList>
        <asp:Button runat="server" CssClass="btn-pages-show" Text="Selecionar" ID="btnFiltroUser" OnClick="btnFiltroUser_Click" />
        <br />
        <br />
